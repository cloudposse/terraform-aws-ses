...
| <a name="input_iam_allowed_resources"></a> [iam\_allowed\_resources](#input\_iam\_allowed\_resources) | Specifies resource ARNs that are enabled for var.iam\_permissions. Wildcards are acceptable. | `list(string)` | `[]` | no |
