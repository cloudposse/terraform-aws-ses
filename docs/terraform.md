...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_ses_user"></a> [ses\_user](#module\_ses\_user) | cloudposse/iam-system-user/aws | 0.21.0 |
...
| <a name="input_iam_allowed_resources"></a> [iam\_allowed\_resources](#input\_iam\_allowed\_resources) | Specifies resource ARNs that are enabled for iam\_permissions above. Wildcards are acceptable. | `list(string)` | `[]` | no |
